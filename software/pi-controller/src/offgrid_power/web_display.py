...
def render_kindle_snapshot(
    ...
    lines = [
        ...
        "<style>",
        "body{font-family:serif;color:#000;background:#fff;margin:3px;font-size:15px;-webkit-text-size-adjust:100%;text-size-adjust:100%;}",
        "h2{font-size:16px;margin:4px 0 1px 0;border-bottom:1px solid #000;}",
        "ul{margin:0 0 3px 16px;padding:0;}",
        "li{line-height:1.1;}",
        "table{border-collapse:collapse;width:100%;}",
        "td{font-size:15px;line-height:1.08;padding:0;vertical-align:top;border-bottom:1px solid #ccc;}",
        "td:first-child{font-size:15px;font-weight:bold;width:32%;}",
...
def render_kindle_weather(
    ...
    lines = [
        ...
        "table{border-collapse:collapse;width:100%;}",
        "td{font-size:15px;line-height:1.08;padding:0;vertical-align:top;border-bottom:1px solid #ccc;}",
        "td:first-child{font-size:15px;font-weight:bold;width:38%;}",
        ".summary-table{margin:0 0 6px 0;border-bottom:1px solid #000;}",
        ".summary-table td{font-size:19px;font-weight:bold;border-bottom:0;padding:0 0 2px 0;}",
