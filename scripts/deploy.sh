...
render config/systemd/offgrid-bms-protection-notify.service | sudo tee /etc/systemd/system/offgrid-bms-protection-notify.service > /dev/null
...
sudo install -m 644 config/systemd/offgrid-bms-protection-notify.timer /etc/systemd/system/
...
sudo systemctl enable --now --quiet offgrid-bms-protection-notify.timer
