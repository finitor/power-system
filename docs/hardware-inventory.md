...
| EPEver TEP10425 | RS485 Modbus RJ45 | `/dev/epever-rs485` (udev symlink to SH-U11H) | COM RJ45 pin 3 -> adapter A/D+, pin 6 -> adapter B/D-, pin 8 -> GND; read-only telemetry enabled |
