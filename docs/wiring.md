...
| 48 V DC bus | MagnaSine 4448 DC input | 48 V nominal | 4/0 | 175 A Class-T (in +) | High-current inverter feed; Class-T is bidirectional/DC-rated. Per MS4448 Table 2-3. See [protection-and-grounding.md](protection-and-grounding.md). **TODO:** Replace existing CCA (copper-clad aluminium) cable with copper 4/0. |
| 48 V DC bus | EPEver TEP charge controller | 48 V nominal | 4 AWG | TBD — **Option A:** 80 A Class-T fuse + DC load-break disconnect (>58.4 V, ~100 A, 4 AWG lugs); **Option B:** MidNite MNEDC80 (in +) | Bidirectional ~80 A protection on positive only; negative stays unbroken (GFP reference). Heschen 125 A rejected (terminals max 16 mm²/6 AWG, can't accept 4 AWG). EPEver reg 0x9013 to be capped ~60 A. See [protection-and-grounding.md](protection-and-grounding.md) |
...
| 48 V system ground | 12 V control bus ground | — | #10 AWG | — | Grounds are bonded. Convenient for the AUX2 relay circuit: Classic AUX2− references 48 V system ground, and relay CH2 sources 12 V from the control bus. An alternative would have been to run 12 V ground directly to the Classic AUX2− terminal instead of relying on the common ground bond. |
...
| RS485 0 | USB-RS485 adapter body / EPever COM lead | KL0823B USB-RS485 (chip: CH340, `1a86:7523`) on USB path `1.3.3`; serves `/dev/epever-rs485`, the EPever TEP10425 COM port |
| RS485 1 | USB-RS485 adapter body / Magnum RJ11 breakout lead | Generic/KL 2-wire USB-RS485 (chip: CH340, `1a86:7523`) on USB path `1.3.2`; serves `/dev/magnum-rs485`, the MagnaSine 4448 network tap |
