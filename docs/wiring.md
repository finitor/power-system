...
| Raspberry Pi USB | MagnaSine 4448 green "Network Accessories" port | RS485 | DSD TECH SH-U11H isolated USB-RS485 (PL2303, `067b:23a3`, serial `DZBSb11CN12`) → `/dev/magnum-rs485`; 4-wire RJ11 cable, RJ45 straight-through coupler, Cat-6 patch, RJ45 screw-terminal breakout | Bench-measured breakout mapping: RJ45 pin 4 +14 V, pin 5 GND, pin 6 RS485 A / D+, pin 3 RS485 B / D-. Wired pin 6 → adapter A/D+, pin 3 → adapter B/D-; pins 4 and 5 left off the adapter. Termination jumpers (`120R T`/`120R R`) left unpopulated — passive mid-bus tap. Confirmed decoding 2026-06-16 (no A/B swap needed). Yellow "Battery Temperature Sensor" port is unoccupied — probe is available but not installed; do not connect while on LiFePO4 (Magnum TCV is lead-acid-tuned and would fight BMS-driven voltage limits). |
